    ...
    <aside class="app-sidebar">
        ...
        <div class="main-sidemenu">
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_dashboard') }}">
                        <i class="side-menu__icon fe fe-grid"></i>
                        <span class="side-menu__label">Trade Market</span>
                    </a>
                </li>

                {{-- <li class="slide">
        <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_crypto_wallets') }}">
            <i class="side-menu__icon fas fa-wallet"></i>
            <span class="side-menu__label">Crypto Wallets</span>
        </a>
    </li> --}}

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_deposit') }}">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_sub_deposit') }}">
                        <i class="side-menu__icon fe fe-repeat"></i>
                        <span class="side-menu__label">Subscription Deposit</span>
                    </a>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_trade') }}">
                ...
                {{-- <li class="slide">
        <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_swap') }}">
            <i class="side-menu__icon fe fe-refresh-cw"></i>
            <span class="side-menu__label">Swap</span>
        </a>
    </li> --}}
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                        ...
                        <span class="side-menu__label">Transactions History</span>
                        <i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_stake') }}">
                        <i class="side-menu__icon fe fe-lock"></i>
                        <span class="side-menu__label">Stake</span>
                    </a>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_card') }}">
                        <i class="side-menu__icon fe fe-credit-card"></i>
                        <span class="side-menu__label">Card</span>
                    </a>
                </li>

                {{-- <li class="slide">
        <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_realEstate') }}">
            <i class="side-menu__icon fe fe-home"></i>
            <span class="side-menu__label">Real Estate</span>
        </a>
    </li> --}}

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('user_withdraw') }}">
