<head>
    ...
    <link href="{{ URL('home-assets/assets/img/forex-logo.png') }}" rel="shortcut icon" type="image/x-icon">
    <link href="{{ URL('home-assets/assets/img/forex-logo.png') }}" rel="apple-touch-icon">
