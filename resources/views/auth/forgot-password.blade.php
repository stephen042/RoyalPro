...
<body class="login-img"
    ...
    <div
        ...
        <div class="container" style="max-width: 440px; width: 100%; padding: 0 16px;">
            ...
            <div
                style="background: rgba(20, 20, 35, 0.55); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 20px; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.4); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); overflow: hidden; width: 100%;">
